...
#define TAM_MAX_DATA 5000

Solicitud::Solicitud() {
    socketLocal = new SocketDatagrama(0);
}

char* Solicitud::doOperation(char * ip,int puerto, int operationid, char* arguments, int tambbuffer, unsigned int id) {
    ...
    mensajeEnvio.tambuffer = tambbuffer;
    ...
    if (n == -1) {
        ...
        //std::cout << _mensaje.arguments << std::endl;
